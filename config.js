...
var b = new Buffer('WGluZXNoaW5lMF8=', 'base64')
var c = new Buffer('bW5qYTEy', 'base64')//'TW5qYTEyMzQ='
config.userName = 'wuxiong';
config.password = b.toString() ;
config.agent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:38.0) Gecko/20100101 Firefox/38.0";
config.host = "cscentral.amazon.com";
//config.web = {};
...
config.bdid = 'xiviwo@qq.com'//'cafe_ie'//'xivhwo2002'//////
